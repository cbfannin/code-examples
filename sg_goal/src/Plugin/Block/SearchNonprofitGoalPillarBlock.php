 ...
 *
 * @Block(
 *   id = "sg_goal_search_nonprofit_goal_pillar",
 *   admin_label = @Translation("Search Nonprofit Goal Pillar"),
 *   category = @Translation("SG Goal"),
 * )
 */
final class SearchNonprofitGoalPillarBlock extends BlockBase  implements ContainerFactoryPluginInterface {
